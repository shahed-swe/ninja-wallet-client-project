...
async function createSampleTransactions() {
  try {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      const response = await fetch('https://ninjawallet.ninja/api/transactions', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Cookie: cookies
    ...
    const intlResponse = await fetch('https://ninjawallet.ninja/api/international-transfer', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Cookie: cookies
    ...
    const investResponse = await fetch('https://ninjawallet.ninja/api/investments', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Cookie: cookies
